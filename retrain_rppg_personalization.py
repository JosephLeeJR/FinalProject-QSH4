...
def retrain_rppg_personalization(data_file,
    ...
    #}
    #model = ks.models.load_model(ModelFile, custom_objects=dependencies)result
    data_in_shape = (875, 1)
    model = define_LSTM5(data_in_shape)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--pers', type=int, default=1, help="If 1, performs personalizatin using data from the test subjct")
